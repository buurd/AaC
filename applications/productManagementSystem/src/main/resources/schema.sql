...
-- Group 1: T-Shirts
INSERT INTO product_groups (id, name, description, base_price, base_unit) VALUES (1, 'Classic T-Shirt', '100% Cotton, soft and comfortable', 25.00, 'pcs');
...
INSERT INTO product_groups (id, name, description, base_price, base_unit) VALUES (2, 'Glass Dessert Cup', 'Elegant glass cups for your favorite desserts', 8.00, 'pcs');
INSERT INTO products (id, group_id, type, name, description, price, unit, attributes) VALUES
...
INSERT INTO product_groups (id, name, description, base_price, base_unit) VALUES (3, 'Artisan Coffee Beans', 'Single-origin, ethically sourced coffee beans', 15.00, 'g');
INSERT INTO products (id, group_id, type, name, description, price, unit, attributes) VALUES
...
-- Group 4: Wooden Bowl
INSERT INTO product_groups (id, name, description, base_price, base_unit) VALUES (4, 'Handcrafted Wooden Bowl', 'Beautiful and unique wooden bowls for your kitchen', 45.00, 'pcs');
INSERT INTO products (id, group_id, type, name, description, price, unit, attributes) VALUES
